...
8010029b:	e8 70 42 00 00       	call   80104510 <acquire>
...
801002f0:	8b 48 28             	mov    0x28(%eax),%ecx
...
8010064e:	e8 bd 3e 00 00       	call   80104510 <acquire>
  for(i = 0; i < n; i++)
...
801007b0:	e8 5b 3d 00 00       	call   80104510 <acquire>
...
80100873:	e8 98 3c 00 00       	call   80104510 <acquire>
  while((c = getc()) >= 0){
...
80100e11:	e8 fa 36 00 00       	call   80104510 <acquire>
...
80100e7f:	e8 8c 36 00 00       	call   80104510 <acquire>
  if(f->ref < 1)
...
80100ed1:	e8 3a 36 00 00       	call   80104510 <acquire>
  if(f->ref < 1)
...
801011f3:	68 df 70 10 80       	push   $0x801070df
...
801012a4:	68 f2 70 10 80       	push   $0x801070f2
...
801012e5:	e8 36 33 00 00       	call   80104620 <memset>
  log_write(bp);
...
8010132a:	e8 e1 31 00 00       	call   80104510 <acquire>
...
80101397:	e8 34 32 00 00       	call   801045d0 <release>
...
801013c5:	e8 06 32 00 00       	call   801045d0 <release>
      return ip;
...
801013f3:	68 08 71 10 80       	push   $0x80107108
...
801014bb:	68 18 71 10 80       	push   $0x80107118
...
801014f1:	e8 ca 31 00 00       	call   801046c0 <memmove>
  brelse(bp);
...
80101526:	e8 85 2e 00 00       	call   801043b0 <initlock>
  for(i = 0; i < NINODE; i++) {
...
8010153f:	e8 3c 2d 00 00       	call   80104280 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801016c1:	e8 fa 2f 00 00       	call   801046c0 <memmove>
  log_write(bp);
...
801016ff:	e8 cc 2e 00 00       	call   801045d0 <release>
}
...
80101732:	e8 89 2b 00 00       	call   801042c0 <acquiresleep>
  if(ip->valid == 0){
...
801017a8:	e8 13 2f 00 00       	call   801046c0 <memmove>
    brelse(bp);
...
80101803:	e8 58 2b 00 00       	call   80104360 <holdingsleep>
...
8010181e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010181f:	e9 fc 2a 00 00       	jmp    80104320 <releasesleep>
    panic("iunlock");
...
80101850:	e8 6b 2a 00 00       	call   801042c0 <acquiresleep>
...
8010186a:	e8 b1 2a 00 00       	call   80104320 <releasesleep>
  acquire(&icache.lock);
...
8010188f:	5d                   	pop    %ebp
  release(&icache.lock);
80101890:	e9 3b 2d 00 00       	jmp    801045d0 <release>
...
801018af:	e8 1c 2d 00 00       	call   801045d0 <release>
    if(r == 1){
...
80101a97:	e8 24 2c 00 00       	call   801046c0 <memmove>
    brelse(bp);
...
80101b93:	e8 28 2b 00 00       	call   801046c0 <memmove>
    log_write(bp);
...
80101c2e:	e8 fd 2a 00 00       	call   80104730 <strncmp>
}
80101c33:	c9                   	leave  
80101c34:	c3                   	ret    
...
80101c8d:	e8 9e 2a 00 00       	call   80104730 <strncmp>
      continue;
...
80101d12:	89 df                	mov    %ebx,%edi
    ip = idup(myproc()->cwd);
80101d14:	8b 70 6c             	mov    0x6c(%eax),%esi
  acquire(&icache.lock);
...
80101d2c:	e8 9f 28 00 00       	call   801045d0 <release>
...
80101d96:	e8 25 29 00 00       	call   801046c0 <memmove>
...
80101e23:	e8 98 28 00 00       	call   801046c0 <memmove>
    name[len] = 0;
...
80101f4d:	e8 3e 28 00 00       	call   80104790 <strncpy>
...
80101f98:	68 7e 77 10 80       	push   $0x8010777e
...
801020e0:	e8 cb 22 00 00       	call   801043b0 <initlock>
...
801021bd:	e8 ee 1e 00 00       	call   801040b0 <wakeup>
...
801021db:	e8 f0 23 00 00       	call   801045d0 <release>
...
801021fe:	e8 5d 21 00 00       	call   80104360 <holdingsleep>
...
80102289:	e8 72 1c 00 00       	call   80103f00 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
801022a5:	c9                   	leave  
  release(&idelock);
801022a6:	e9 25 23 00 00       	jmp    801045d0 <release>
...
8010233a:	68 54 72 10 80       	push   $0x80107254
...
80102412:	e8 09 22 00 00       	call   80104620 <memset>
...
80102448:	e8 c3 20 00 00       	call   80104510 <acquire>
...
80102462:	c9                   	leave  
    release(&kmem.lock);
80102463:	e9 68 21 00 00       	jmp    801045d0 <release>
    panic("kfree");
80102468:	83 ec 0c             	sub    $0xc,%esp
8010246b:	68 86 72 10 80       	push   $0x80107286
...
801024db:	68 8c 72 10 80       	push   $0x8010728c
801024e0:	68 40 26 11 80       	push   $0x80112640
801024e5:	e8 c6 1e 00 00       	call   801043b0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801025d8:	e8 33 1f 00 00       	call   80104510 <acquire>
  r = kmem.freelist;
...
80102603:	e8 c8 1f 00 00       	call   801045d0 <release>
}
...
8010265f:	0f b6 8a c0 73 10 80 	movzbl -0x7fef8c40(%edx),%ecx
  shift ^= togglecode[data];
80102666:	0f b6 82 c0 72 10 80 	movzbl -0x7fef8d40(%edx),%eax
  shift |= shiftcode[data];
...
8010267c:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
8010267f:	8b 04 85 a0 72 10 80 	mov    -0x7fef8d60(,%eax,4),%eax
...
801026b8:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
801026ba:	0f b6 8a c0 73 10 80 	movzbl -0x7fef8c40(%edx),%ecx
...
80102a27:	e8 44 1c 00 00       	call   80104670 <memcmp>
...
80102b54:	e8 67 1b 00 00       	call   801046c0 <memmove>
...
80102bfa:	68 c0 74 10 80       	push   $0x801074c0
80102bff:	68 80 26 11 80       	push   $0x80112680
80102c04:	e8 a7 17 00 00       	call   801043b0 <initlock>
  readsb(dev, &sb);
80102c09:	58                   	pop    %eax
...
80102c9b:	e8 70 18 00 00       	call   80104510 <acquire>
...
80102cb5:	e8 46 12 00 00       	call   80103f00 <sleep>
...
80102cec:	e8 df 18 00 00       	call   801045d0 <release>
      break;
    }
  }
}
...
80102d0e:	e8 fd 17 00 00       	call   80104510 <acquire>
  log.outstanding -= 1;
...
80102d4c:	e8 7f 18 00 00       	call   801045d0 <release>
}
...
80102d66:	e8 a5 17 00 00       	call   80104510 <acquire>
    wakeup(&log);
...
80102d79:	00 00 00 
    wakeup(&log);
80102d7c:	e8 2f 13 00 00       	call   801040b0 <wakeup>
    release(&log.lock);
80102d81:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d88:	e8 43 18 00 00       	call   801045d0 <release>
...
80102de4:	e8 d7 18 00 00       	call   801046c0 <memmove>
...
80102e38:	e8 73 12 00 00       	call   801040b0 <wakeup>
  release(&log.lock);
80102e3d:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102e44:	e8 87 17 00 00       	call   801045d0 <release>
...
80102e57:	68 c4 74 10 80       	push   $0x801074c4
...
80102eae:	e8 5d 16 00 00       	call   80104510 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102efd:	c9                   	leave  
  release(&log.lock);
80102efe:	e9 cd 16 00 00       	jmp    801045d0 <release>
...
80102f20:	68 d3 74 10 80       	push   $0x801074d3
80102f25:	e8 66 d4 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102f2a:	83 ec 0c             	sub    $0xc,%esp
80102f2d:	68 e9 74 10 80       	push   $0x801074e9
...
80102f58:	68 04 75 10 80       	push   $0x80107504
80102f5d:	e8 4e d7 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80102f62:	e8 e9 28 00 00       	call   80105850 <idtinit>
...
80102f7a:	e8 51 0c 00 00       	call   80103bd0 <scheduler>
80102f7f:	90                   	nop
...
80102fb7:	68 a8 55 11 80       	push   $0x801155a8
...
80102fe9:	e8 22 08 00 00       	call   80103810 <pinit>
  tvinit();        // trap vectors
80102fee:	e8 dd 27 00 00       	call   801057d0 <tvinit>
  binit();         // buffer cache
...
80103014:	e8 a7 16 00 00       	call   801046c0 <memmove>
...
801030fe:	68 18 75 10 80       	push   $0x80107518
80103103:	56                   	push   %esi
80103104:	e8 67 15 00 00       	call   80104670 <memcmp>
...
801031b6:	68 35 75 10 80       	push   $0x80107535
801031bb:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
801031bc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
801031bf:	e8 ac 14 00 00       	call   80104670 <memcmp>
...
80103258:	ff 24 95 5c 75 10 80 	jmp    *-0x7fef8aa4(,%edx,4)
8010325f:	90                   	nop
...
80103283:	68 1d 75 10 80       	push   $0x8010751d
...
8010330d:	68 3c 75 10 80       	push   $0x8010753c
...
801033b0:	00 00 00 
  initlock(&p->lock, "pipe");
801033b3:	68 70 75 10 80       	push   $0x80107570
801033b8:	50                   	push   %eax
801033b9:	e8 f2 0f 00 00       	call   801043b0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010344f:	e8 bc 10 00 00       	call   80104510 <acquire>
  if(writable){
...
8010346f:	e8 3c 0c 00 00       	call   801040b0 <wakeup>
...
80103493:	5d                   	pop    %ebp
    release(&p->lock);
80103494:	e9 37 11 00 00       	jmp    801045d0 <release>
80103499:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
801034a0:	83 ec 0c             	sub    $0xc,%esp
801034a3:	53                   	push   %ebx
801034a4:	e8 27 11 00 00       	call   801045d0 <release>
    kfree((char*)p);
...
801034d4:	e8 d7 0b 00 00       	call   801040b0 <wakeup>
...
801034ed:	e8 1e 10 00 00       	call   80104510 <acquire>
  for(i = 0; i < n; i++){
...
80103544:	e8 67 0b 00 00       	call   801040b0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103549:	5a                   	pop    %edx
8010354a:	59                   	pop    %ecx
8010354b:	53                   	push   %ebx
8010354c:	56                   	push   %esi
8010354d:	e8 ae 09 00 00       	call   80103f00 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103579:	8b 40 28             	mov    0x28(%eax),%eax
...
801035d2:	e8 d9 0a 00 00       	call   801040b0 <wakeup>
  release(&p->lock);
801035d7:	89 1c 24             	mov    %ebx,(%esp)
801035da:	e8 f1 0f 00 00       	call   801045d0 <release>
  return n;
...
80103600:	e8 0b 0f 00 00       	call   80104510 <acquire>
...
80103635:	e8 c6 08 00 00       	call   80103f00 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010365e:	8b 48 28             	mov    0x28(%eax),%ecx
...
8010366e:	e8 5d 0f 00 00       	call   801045d0 <release>
      return -1;
...
801036c7:	e8 e4 09 00 00       	call   801040b0 <wakeup>
  release(&p->lock);
801036cc:	89 34 24             	mov    %esi,(%esp)
801036cf:	e8 fc 0e 00 00       	call   801045d0 <release>
  return i;
...
80103701:	e8 0a 0e 00 00       	call   80104510 <acquire>
...
80103713:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103719:	74 75                	je     80103790 <allocproc+0xa0>
    if(p->state == UNUSED)
8010371b:	8b 43 10             	mov    0x10(%ebx),%eax
...
80103727:	83 ec 0c             	sub    $0xc,%esp
  p->state = EMBRYO;
8010372a:	c7 43 10 01 00 00 00 	movl   $0x1,0x10(%ebx)
  p->pid = nextpid++;
80103731:	89 43 14             	mov    %eax,0x14(%ebx)
...
8010375f:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103764:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103767:	c7 40 14 c2 57 10 80 	movl   $0x801057c2,0x14(%eax)
  p->context = (struct context*)sp;
8010376e:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103771:	6a 14                	push   $0x14
80103773:	6a 00                	push   $0x0
80103775:	50                   	push   %eax
80103776:	e8 a5 0e 00 00       	call   80104620 <memset>
  p->context->eip = (uint)forkret;
8010377b:	8b 43 20             	mov    0x20(%ebx),%eax
...
8010379a:	e8 31 0e 00 00       	call   801045d0 <release>
}
...
801037a8:	c3                   	ret    
    p->state = UNUSED;
801037a9:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return 0;
...
801037cb:	e8 00 0e 00 00       	call   801045d0 <release>
...
80103816:	68 75 75 10 80       	push   $0x80107575
8010381b:	68 20 2d 11 80       	push   $0x80112d20
80103820:	e8 8b 0b 00 00       	call   801043b0 <initlock>
}
...
801038d4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801038d7:	e8 44 0b 00 00       	call   80104420 <pushcli>
  c = mycpu();
801038dc:	e8 4f ff ff ff       	call   80103830 <mycpu>
  p = c->proc;
801038e1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038e7:	e8 84 0b 00 00       	call   80104470 <popcli>
}
...
80103904:	83 ec 04             	sub    $0x4,%esp
  ptable.HEAD=0;
80103907:	c7 05 54 4d 11 80 00 	movl   $0x0,0x80114d54
8010390e:	00 00 00 
  p = allocproc();
80103911:	e8 da fd ff ff       	call   801036f0 <allocproc>
80103916:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103918:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
  if((p->pgdir = setupkvm()) == 0)
8010391d:	e8 6e 34 00 00       	call   80106d90 <setupkvm>
80103922:	89 43 08             	mov    %eax,0x8(%ebx)
80103925:	85 c0                	test   %eax,%eax
80103927:	0f 84 ca 00 00 00    	je     801039f7 <userinit+0xf7>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
8010392d:	83 ec 04             	sub    $0x4,%esp
80103930:	68 2c 00 00 00       	push   $0x2c
80103935:	68 60 a4 10 80       	push   $0x8010a460
8010393a:	50                   	push   %eax
8010393b:	e8 30 31 00 00       	call   80106a70 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
80103940:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
80103943:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103949:	6a 4c                	push   $0x4c
8010394b:	6a 00                	push   $0x0
8010394d:	ff 73 1c             	pushl  0x1c(%ebx)
80103950:	e8 cb 0c 00 00       	call   80104620 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103955:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103958:	ba 1b 00 00 00       	mov    $0x1b,%edx
  safestrcpy(p->name, "initcode", sizeof(p->name));
8010395d:	83 c4 0c             	add    $0xc,%esp
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103960:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103965:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103969:	8b 43 1c             	mov    0x1c(%ebx),%eax
8010396c:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103970:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103973:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103977:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
8010397b:	8b 43 1c             	mov    0x1c(%ebx),%eax
8010397e:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103982:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103986:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103989:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103990:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103993:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
8010399a:	8b 43 1c             	mov    0x1c(%ebx),%eax
8010399d:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
801039a4:	8d 43 70             	lea    0x70(%ebx),%eax
  p->next=0;
801039a7:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
  safestrcpy(p->name, "initcode", sizeof(p->name));
801039ae:	6a 10                	push   $0x10
801039b0:	68 a5 75 10 80       	push   $0x801075a5
801039b5:	50                   	push   %eax
801039b6:	e8 35 0e 00 00       	call   801047f0 <safestrcpy>
  p->cwd = namei("/");
801039bb:	c7 04 24 ae 75 10 80 	movl   $0x801075ae,(%esp)
801039c2:	e8 e9 e5 ff ff       	call   80101fb0 <namei>
801039c7:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
801039ca:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801039d1:	e8 3a 0b 00 00       	call   80104510 <acquire>
  p->state = RUNNABLE;
801039d6:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  ptable.HEAD= p;
801039dd:	89 1d 54 4d 11 80    	mov    %ebx,0x80114d54
  release(&ptable.lock);
801039e3:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801039ea:	e8 e1 0b 00 00       	call   801045d0 <release>
}
...
801039fa:	68 8c 75 10 80       	push   $0x8010758c
801039ff:	e8 8c c9 ff ff       	call   80100390 <panic>
...
80103a15:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a18:	e8 03 0a 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103a1d:	e8 0e fe ff ff       	call   80103830 <mycpu>
  p = c->proc;
80103a22:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a28:	e8 43 0a 00 00       	call   80104470 <popcli>
  sz = curproc->sz;
...
80103a3b:	e8 20 2f 00 00       	call   80106960 <switchuvm>
  return 0;
...
80103a57:	ff 73 08             	pushl  0x8(%ebx)
80103a5a:	e8 51 31 00 00       	call   80106bb0 <allocuvm>
...
80103a77:	ff 73 08             	pushl  0x8(%ebx)
80103a7a:	e8 61 32 00 00       	call   80106ce0 <deallocuvm>
...
80103b41:	e8 aa 0c 00 00       	call   801047f0 <safestrcpy>
  pid = np->pid;
80103b46:	8b 5f 14             	mov    0x14(%edi),%ebx
  acquire(&ptable.lock);
80103b49:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b50:	e8 bb 09 00 00       	call   80104510 <acquire>
  np->state = RUNNABLE;
80103b55:	c7 47 10 03 00 00 00 	movl   $0x3,0x10(%edi)
  if(ptable.HEAD==0){
80103b5c:	83 c4 10             	add    $0x10,%esp
80103b5f:	a1 54 4d 11 80       	mov    0x80114d54,%eax
80103b64:	85 c0                	test   %eax,%eax
80103b66:	74 28                	je     80103b90 <fork+0x100>
    np->next=ptable.HEAD;
80103b68:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103b6b:	89 41 04             	mov    %eax,0x4(%ecx)
    ptable.HEAD=np;
80103b6e:	89 0d 54 4d 11 80    	mov    %ecx,0x80114d54
  release(&ptable.lock);
80103b74:	83 ec 0c             	sub    $0xc,%esp
80103b77:	68 20 2d 11 80       	push   $0x80112d20
80103b7c:	e8 4f 0a 00 00       	call   801045d0 <release>
  return pid;
80103b81:	83 c4 10             	add    $0x10,%esp
}
80103b84:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103b87:	89 d8                	mov    %ebx,%eax
80103b89:	5b                   	pop    %ebx
80103b8a:	5e                   	pop    %esi
80103b8b:	5f                   	pop    %edi
80103b8c:	5d                   	pop    %ebp
...
80103b8e:	66 90                	xchg   %ax,%ax
    ptable.HEAD=np;
80103b90:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103b93:	a3 54 4d 11 80       	mov    %eax,0x80114d54
80103b98:	eb da                	jmp    80103b74 <fork+0xe4>
    return -1;
80103b9a:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103b9f:	eb e3                	jmp    80103b84 <fork+0xf4>
    kfree(np->kstack);
80103ba1:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103ba4:	83 ec 0c             	sub    $0xc,%esp
80103ba7:	ff 73 0c             	pushl  0xc(%ebx)
80103baa:	e8 31 e8 ff ff       	call   801023e0 <kfree>
    np->kstack = 0;
80103baf:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103bb6:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103bb9:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
80103bc0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103bc5:	eb bd                	jmp    80103b84 <fork+0xf4>
...
80103bd6:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103bd9:	e8 52 fc ff ff       	call   80103830 <mycpu>
  c->proc = 0;
...
80103bf4:	68 20 2d 11 80       	push   $0x80112d20
80103bf9:	e8 12 09 00 00       	call   80104510 <acquire>
    p=ptable.HEAD;
80103bfe:	8b 1d 54 4d 11 80    	mov    0x80114d54,%ebx
    if(p!=0)
80103c04:	83 c4 10             	add    $0x10,%esp
80103c07:	85 db                	test   %ebx,%ebx
80103c09:	74 3b                	je     80103c46 <scheduler+0x76>
      ptable.HEAD=ptable.HEAD->next;
80103c0b:	8b 43 04             	mov    0x4(%ebx),%eax
      switchuvm(p);
80103c0e:	83 ec 0c             	sub    $0xc,%esp
      ptable.HEAD=ptable.HEAD->next;
80103c11:	a3 54 4d 11 80       	mov    %eax,0x80114d54
      c->proc = p;
80103c16:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
80103c1c:	53                   	push   %ebx
80103c1d:	e8 3e 2d 00 00       	call   80106960 <switchuvm>
      p->state = RUNNING;
80103c22:	c7 43 10 04 00 00 00 	movl   $0x4,0x10(%ebx)
      swtch(&(c->scheduler), p->context);
80103c29:	58                   	pop    %eax
80103c2a:	5a                   	pop    %edx
80103c2b:	ff 73 20             	pushl  0x20(%ebx)
80103c2e:	57                   	push   %edi
80103c2f:	e8 17 0c 00 00       	call   8010484b <swtch>
      switchkvm();
80103c34:	e8 17 2d 00 00       	call   80106950 <switchkvm>
      c->proc = 0;
80103c39:	83 c4 10             	add    $0x10,%esp
80103c3c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103c43:	00 00 00 
    release(&ptable.lock);
80103c46:	83 ec 0c             	sub    $0xc,%esp
80103c49:	68 20 2d 11 80       	push   $0x80112d20
80103c4e:	e8 7d 09 00 00       	call   801045d0 <release>
    sti();
80103c53:	83 c4 10             	add    $0x10,%esp
80103c56:	eb 98                	jmp    80103bf0 <scheduler+0x20>
...
80103c9a:	75 68                	jne    80103d04 <sched+0xa4>
  if(p->state == RUNNING)
80103c9c:	83 7b 10 04          	cmpl   $0x4,0x10(%ebx)
...
80103cae:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
...
80103cc3:	e8 83 0b 00 00       	call   8010484b <swtch>
  mycpu()->intena = intena;
...
80103d26:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d29:	e8 f2 06 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103d2e:	e8 fd fa ff ff       	call   80103830 <mycpu>
  p = c->proc;
80103d33:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d39:	e8 32 07 00 00       	call   80104470 <popcli>
  if(curproc == initproc)
80103d3e:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103d41:	8d 7e 6c             	lea    0x6c(%esi),%edi
80103d44:	39 35 b8 a5 10 80    	cmp    %esi,0x8010a5b8
80103d4a:	0f 84 09 01 00 00    	je     80103e59 <exit+0x139>
    if(curproc->ofile[fd]){
...
80103d77:	ff 76 6c             	pushl  0x6c(%esi)
80103d7a:	e8 c1 da ff ff       	call   80101840 <iput>
  end_op();
80103d7f:	e8 7c ef ff ff       	call   80102d00 <end_op>
  curproc->cwd = 0;
80103d84:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  acquire(&ptable.lock);
80103d8b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d92:	e8 79 07 00 00       	call   80104510 <acquire>
  wakeup1(curproc->parent);
80103d97:	8b 56 18             	mov    0x18(%esi),%edx
...
80103dab:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80103db0:	74 2e                	je     80103de0 <exit+0xc0>
  {
    if(p->state == SLEEPING && p->chan == chan)
80103db2:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103db6:	75 f0                	jne    80103da8 <exit+0x88>
80103db8:	3b 50 24             	cmp    0x24(%eax),%edx
...
80103dbd:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      ...
      if(ptable.HEAD==0){
80103dc4:	8b 0d 54 4d 11 80    	mov    0x80114d54,%ecx
80103dca:	85 c9                	test   %ecx,%ecx
80103dcc:	74 03                	je     80103dd1 <exit+0xb1>
      ptable.HEAD=p;
      }
      else{
        p->next=ptable.HEAD;
80103dce:	89 48 04             	mov    %ecx,0x4(%eax)
        ptable.HEAD=p;
80103dd1:	a3 54 4d 11 80       	mov    %eax,0x80114d54
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103dd6:	83 e8 80             	sub    $0xffffff80,%eax
80103dd9:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80103dde:	75 d2                	jne    80103db2 <exit+0x92>
      p->parent = initproc;
80103de0:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103de6:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103deb:	eb 0e                	jmp    80103dfb <exit+0xdb>
80103ded:	8d 76 00             	lea    0x0(%esi),%esi
80103df0:	83 ea 80             	sub    $0xffffff80,%edx
80103df3:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
80103df9:	74 45                	je     80103e40 <exit+0x120>
    if(p->parent == curproc){
80103dfb:	39 72 18             	cmp    %esi,0x18(%edx)
80103dfe:	75 f0                	jne    80103df0 <exit+0xd0>
      if(p->state == ZOMBIE)
80103e00:	83 7a 10 05          	cmpl   $0x5,0x10(%edx)
      p->parent = initproc;
80103e04:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
80103e07:	75 e7                	jne    80103df0 <exit+0xd0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e09:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103e0e:	eb 0a                	jmp    80103e1a <exit+0xfa>
80103e10:	83 e8 80             	sub    $0xffffff80,%eax
80103e13:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80103e18:	74 d6                	je     80103df0 <exit+0xd0>
    if(p->state == SLEEPING && p->chan == chan)
80103e1a:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103e1e:	75 f0                	jne    80103e10 <exit+0xf0>
80103e20:	3b 48 24             	cmp    0x24(%eax),%ecx
80103e23:	75 eb                	jne    80103e10 <exit+0xf0>
      p->state = RUNNABLE;
80103e25:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      if(ptable.HEAD==0){
80103e2c:	8b 1d 54 4d 11 80    	mov    0x80114d54,%ebx
80103e32:	85 db                	test   %ebx,%ebx
80103e34:	74 03                	je     80103e39 <exit+0x119>
        p->next=ptable.HEAD;
80103e36:	89 58 04             	mov    %ebx,0x4(%eax)
        ptable.HEAD=p;
80103e39:	a3 54 4d 11 80       	mov    %eax,0x80114d54
80103e3e:	eb d0                	jmp    80103e10 <exit+0xf0>
  curproc->state = ZOMBIE;
80103e40:	c7 46 10 05 00 00 00 	movl   $0x5,0x10(%esi)
  sched();
80103e47:	e8 14 fe ff ff       	call   80103c60 <sched>
  panic("zombie exit");
80103e4c:	83 ec 0c             	sub    $0xc,%esp
80103e4f:	68 fd 75 10 80       	push   $0x801075fd
80103e54:	e8 37 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e59:	83 ec 0c             	sub    $0xc,%esp
80103e5c:	68 f0 75 10 80       	push   $0x801075f0
80103e61:	e8 2a c5 ff ff       	call   80100390 <panic>
...
80103e7c:	e8 8f 06 00 00       	call   80104510 <acquire>
  pushcli();
80103e81:	e8 9a 05 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103e86:	e8 a5 f9 ff ff       	call   80103830 <mycpu>
  p = c->proc;
80103e8b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e91:	e8 da 05 00 00       	call   80104470 <popcli>
  if(ptable.HEAD==0){
80103e96:	83 c4 10             	add    $0x10,%esp
  myproc()->state = RUNNABLE;
80103e99:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  if(ptable.HEAD==0){
80103ea0:	a1 54 4d 11 80       	mov    0x80114d54,%eax
80103ea5:	85 c0                	test   %eax,%eax
80103ea7:	74 1d                	je     80103ec6 <yield+0x56>
  pushcli();
80103ea9:	e8 72 05 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103eae:	e8 7d f9 ff ff       	call   80103830 <mycpu>
  p = c->proc;
80103eb3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103eb9:	e8 b2 05 00 00       	call   80104470 <popcli>
    myproc()->next=ptable.HEAD;
80103ebe:	a1 54 4d 11 80       	mov    0x80114d54,%eax
80103ec3:	89 43 04             	mov    %eax,0x4(%ebx)
  pushcli();
80103ec6:	e8 55 05 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103ecb:	e8 60 f9 ff ff       	call   80103830 <mycpu>
  p = c->proc;
80103ed0:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ed6:	e8 95 05 00 00       	call   80104470 <popcli>
    ptable.HEAD=myproc();
80103edb:	89 1d 54 4d 11 80    	mov    %ebx,0x80114d54
  sched();
80103ee1:	e8 7a fd ff ff       	call   80103c60 <sched>
  release(&ptable.lock);
80103ee6:	83 ec 0c             	sub    $0xc,%esp
80103ee9:	68 20 2d 11 80       	push   $0x80112d20
80103eee:	e8 dd 06 00 00       	call   801045d0 <release>
}
...
80103f0c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f0f:	e8 0c 05 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103f14:	e8 17 f9 ff ff       	call   80103830 <mycpu>
  p = c->proc;
80103f19:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f1f:	e8 4c 05 00 00       	call   80104470 <popcli>
  if(p == 0)
...
80103f40:	e8 cb 05 00 00       	call   80104510 <acquire>
    release(lk);
80103f45:	89 34 24             	mov    %esi,(%esp)
80103f48:	e8 83 06 00 00       	call   801045d0 <release>
  p->chan = chan;
80103f4d:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80103f50:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80103f57:	e8 04 fd ff ff       	call   80103c60 <sched>
  p->chan = 0;
80103f5c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
80103f63:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f6a:	e8 61 06 00 00       	call   801045d0 <release>
    acquire(lk);
...
80103f7b:	5d                   	pop    %ebp
    acquire(lk);
80103f7c:	e9 8f 05 00 00       	jmp    80104510 <acquire>
80103f81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
80103f88:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80103f8b:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80103f92:	e8 c9 fc ff ff       	call   80103c60 <sched>
  p->chan = 0;
...
80103fa9:	68 0f 76 10 80       	push   $0x8010760f
80103fae:	e8 dd c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80103fb3:	83 ec 0c             	sub    $0xc,%esp
80103fb6:	68 09 76 10 80       	push   $0x80107609
...
80103fc4:	53                   	push   %ebx
  pushcli();
80103fc5:	e8 56 04 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103fca:	e8 61 f8 ff ff       	call   80103830 <mycpu>
  p = c->proc;
...
80103fe2:	e8 29 05 00 00       	call   80104510 <acquire>
...
80104001:	74 1b                	je     8010401e <wait+0x5e>
      if(p->parent != curproc)
80104003:	39 73 18             	cmp    %esi,0x18(%ebx)
80104006:	75 f0                	jne    80103ff8 <wait+0x38>
      if(p->state == ZOMBIE){
80104008:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
...
80104022:	8b 46 28             	mov    0x28(%esi),%eax
...
80104043:	ff 73 0c             	pushl  0xc(%ebx)
        pid = p->pid;
80104046:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
80104049:	e8 92 e3 ff ff       	call   801023e0 <kfree>
        freevm(p->pgdir);
8010404e:	5a                   	pop    %edx
8010404f:	ff 73 08             	pushl  0x8(%ebx)
        p->kstack = 0;
80104052:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        freevm(p->pgdir);
80104059:	e8 b2 2c 00 00       	call   80106d10 <freevm>
        release(&ptable.lock);
8010405e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80104065:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
8010406c:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
80104073:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80104077:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
8010407e:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
80104085:	e8 46 05 00 00       	call   801045d0 <release>
        return pid;
...
801040a3:	e8 28 05 00 00       	call   801045d0 <release>
      return -1;
...
801040bf:	e8 4c 04 00 00       	call   80104510 <acquire>
...
801040d8:	74 2e                	je     80104108 <wakeup+0x58>
    if(p->state == SLEEPING && p->chan == chan)
801040da:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
801040de:	75 f0                	jne    801040d0 <wakeup+0x20>
801040e0:	3b 58 24             	cmp    0x24(%eax),%ebx
801040e3:	75 eb                	jne    801040d0 <wakeup+0x20>
      p->state = RUNNABLE;
801040e5:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      if(ptable.HEAD==0){
801040ec:	8b 15 54 4d 11 80    	mov    0x80114d54,%edx
801040f2:	85 d2                	test   %edx,%edx
801040f4:	74 03                	je     801040f9 <wakeup+0x49>
        p->next=ptable.HEAD;
801040f6:	89 50 04             	mov    %edx,0x4(%eax)
        ptable.HEAD=p;
801040f9:	a3 54 4d 11 80       	mov    %eax,0x80114d54
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040fe:	83 e8 80             	sub    $0xffffff80,%eax
80104101:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80104106:	75 d2                	jne    801040da <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104108:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
8010410f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104112:	c9                   	leave  
  release(&ptable.lock);
80104113:	e9 b8 04 00 00       	jmp    801045d0 <release>
...
8010412f:	e8 dc 03 00 00       	call   80104510 <acquire>
...
80104143:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80104148:	74 4e                	je     80104198 <kill+0x78>
    if(p->pid == pid){
8010414a:	39 58 14             	cmp    %ebx,0x14(%eax)
8010414d:	75 f1                	jne    80104140 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010414f:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
      p->killed = 1;
80104153:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
8010415a:	74 1c                	je     80104178 <kill+0x58>
          p->next=ptable.HEAD;
          ptable.HEAD=p;
        }      
      }
...
8010415f:	68 20 2d 11 80       	push   $0x80112d20
80104164:	e8 67 04 00 00       	call   801045d0 <release>
      return 0;
80104169:	83 c4 10             	add    $0x10,%esp
8010416c:	31 c0                	xor    %eax,%eax
    }
  }
  release(&ptable.lock);
  return -1;
...
80104177:	90                   	nop
        p->state = RUNNABLE;
80104178:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
        if(ptable.HEAD==0){
8010417f:	8b 15 54 4d 11 80    	mov    0x80114d54,%edx
80104185:	85 d2                	test   %edx,%edx
80104187:	74 03                	je     8010418c <kill+0x6c>
          p->next=ptable.HEAD;
80104189:	89 50 04             	mov    %edx,0x4(%eax)
          ptable.HEAD=p;
8010418c:	a3 54 4d 11 80       	mov    %eax,0x80114d54
80104191:	eb c9                	jmp    8010415c <kill+0x3c>
80104193:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104197:	90                   	nop
  release(&ptable.lock);
80104198:	83 ec 0c             	sub    $0xc,%esp
8010419b:	68 20 2d 11 80       	push   $0x80112d20
801041a0:	e8 2b 04 00 00       	call   801045d0 <release>
  return -1;
...
801041c9:	bb c4 2d 11 80       	mov    $0x80112dc4,%ebx
...
801041fc:	74 ea                	je     801041e8 <procdump+0x28>
      state = "???";
801041fe:	ba 20 76 10 80       	mov    $0x80107620,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104203:	83 f8 05             	cmp    $0x5,%eax
80104206:	77 11                	ja     80104219 <procdump+0x59>
80104208:	8b 14 85 80 76 10 80 	mov    -0x7fef8980(,%eax,4),%edx
      state = "???";
8010420f:	b8 20 76 10 80       	mov    $0x80107620,%eax
...
8010421e:	68 24 76 10 80       	push   $0x80107624
...
8010425d:	68 61 70 10 80       	push   $0x80107061
...
801042b1:	c9                   	leave  
801042b2:	c3                   	ret    
801042b3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801042e5:	e8 16 fc ff ff       	call   80103f00 <sleep>
  while (lk->locked) {
...
801042f3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801042f9:	e8 d2 f5 ff ff       	call   801038d0 <myproc>
801042fe:	8b 40 14             	mov    0x14(%eax),%eax
...
8010430c:	5d                   	pop    %ebp
  release(&lk->lk);
8010430d:	e9 be 02 00 00       	jmp    801045d0 <release>
...
80104344:	e8 67 fd ff ff       	call   801040b0 <wakeup>
  release(&lk->lk);
...
80104354:	5d                   	pop    %ebp
  release(&lk->lk);
80104355:	e9 76 02 00 00       	jmp    801045d0 <release>
...
80104384:	e8 47 02 00 00       	call   801045d0 <release>
  return r;
}
...
8010439b:	e8 30 f5 ff ff       	call   801038d0 <myproc>
801043a0:	39 58 14             	cmp    %ebx,0x14(%eax)
...
80104429:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010442a:	e8 01 f4 ff ff       	call   80103830 <mycpu>
8010442f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104435:	85 c0                	test   %eax,%eax
80104437:	74 17                	je     80104450 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80104439:	e8 f2 f3 ff ff       	call   80103830 <mycpu>
8010443e:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
80104445:	83 c4 04             	add    $0x4,%esp
80104448:	5b                   	pop    %ebx
80104449:	5d                   	pop    %ebp
8010444a:	c3                   	ret    
...
8010444f:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
80104450:	e8 db f3 ff ff       	call   80103830 <mycpu>
80104455:	81 e3 00 02 00 00    	and    $0x200,%ebx
8010445b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80104461:	eb d6                	jmp    80104439 <pushcli+0x19>
...
8010449c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044a0:	e8 8b f3 ff ff       	call   80103830 <mycpu>
...
801044b5:	68 a3 76 10 80       	push   $0x801076a3
801044ba:	e8 d1 be ff ff       	call   80100390 <panic>
    panic("popcli");
801044bf:	83 ec 0c             	sub    $0xc,%esp
801044c2:	68 ba 76 10 80       	push   $0x801076ba
...
801044e3:	75 0b                	jne    801044f0 <holding+0x20>
  popcli();
801044e5:	e8 86 ff ff ff       	call   80104470 <popcli>
}
...
801044ef:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
801044f0:	8b 5e 08             	mov    0x8(%esi),%ebx
801044f3:	e8 38 f3 ff ff       	call   80103830 <mycpu>
801044f8:	39 c3                	cmp    %eax,%ebx
801044fa:	0f 94 c3             	sete   %bl
  popcli();
801044fd:	e8 6e ff ff ff       	call   80104470 <popcli>
  r = lock->locked && lock->cpu == mycpu();
...
80104515:	e8 06 ff ff ff       	call   80104420 <pushcli>
  if(holding(lk))
8010451a:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010451d:	83 ec 0c             	sub    $0xc,%esp
80104520:	53                   	push   %ebx
80104521:	e8 aa ff ff ff       	call   801044d0 <holding>
80104526:	83 c4 10             	add    $0x10,%esp
80104529:	85 c0                	test   %eax,%eax
8010452b:	0f 85 83 00 00 00    	jne    801045b4 <acquire+0xa4>
...
80104554:	e8 d7 f2 ff ff       	call   80103830 <mycpu>
...
801045b7:	68 c1 76 10 80       	push   $0x801076c1
...
801045db:	e8 f0 fe ff ff       	call   801044d0 <holding>
...
80104603:	c9                   	leave  
  popcli();
80104604:	e9 67 fe ff ff       	jmp    80104470 <popcli>
    panic("release");
80104609:	83 ec 0c             	sub    $0xc,%esp
8010460c:	68 c9 76 10 80       	push   $0x801076c9
80104611:	e8 7a bd ff ff       	call   80100390 <panic>
...
80104867:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010486a:	e8 61 f0 ff ff       	call   801038d0 <myproc>
...
801048a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801048aa:	e8 21 f0 ff ff       	call   801038d0 <myproc>
...
80104905:	e8 c6 ef ff ff       	call   801038d0 <myproc>
...
80104913:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104916:	e8 b5 ef ff ff       	call   801038d0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104958:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010495b:	e8 70 ef ff ff       	call   801038d0 <myproc>
...
801049f4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801049f7:	e8 d4 ee ff ff       	call   801038d0 <myproc>
...
80104a28:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104a29:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104a2c:	50                   	push   %eax
80104a2d:	ff 73 14             	pushl  0x14(%ebx)
80104a30:	68 d1 76 10 80       	push   $0x801076d1
...
80104a67:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104a6a:	e8 61 d5 ff ff       	call   80101fd0 <nameiparent>
...
80104a8b:	56                   	push   %esi
80104a8c:	e8 af d1 ff ff       	call   80101c40 <dirlookup>
80104a91:	83 c4 10             	add    $0x10,%esp
80104a94:	89 c7                	mov    %eax,%edi
80104a96:	85 c0                	test   %eax,%eax
80104a98:	74 56                	je     80104af0 <create+0xa0>
    iunlockput(dp);
80104a9a:	83 ec 0c             	sub    $0xc,%esp
80104a9d:	56                   	push   %esi
80104a9e:	e8 fd ce ff ff       	call   801019a0 <iunlockput>
    ilock(ip);
80104aa3:	89 3c 24             	mov    %edi,(%esp)
80104aa6:	e8 65 cc ff ff       	call   80101710 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104aab:	83 c4 10             	add    $0x10,%esp
80104aae:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104ab3:	75 1b                	jne    80104ad0 <create+0x80>
80104ab5:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104aba:	75 14                	jne    80104ad0 <create+0x80>
...
80104ad4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104ad6:	e8 c5 ce ff ff       	call   801019a0 <iunlockput>
    return 0;
...
80104afa:	e8 a1 ca ff ff       	call   801015a0 <ialloc>
...
80104b10:	e8 fb cb ff ff       	call   80101710 <ilock>
  ip->major = major;
80104b15:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104b19:	66 89 47 52          	mov    %ax,0x52(%edi)
  ip->minor = minor;
80104b1d:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
...
80104b31:	e8 2a cb ff ff       	call   80101660 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104b36:	83 c4 10             	add    $0x10,%esp
80104b39:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
...
80104b48:	e8 a3 d3 ff ff       	call   80101ef0 <dirlink>
...
80104b58:	e8 43 ce ff ff       	call   801019a0 <iunlockput>
  return ip;
...
80104b79:	e8 e2 ca ff ff       	call   80101660 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104b7e:	83 c4 0c             	add    $0xc,%esp
80104b81:	ff 77 04             	pushl  0x4(%edi)
80104b84:	68 74 77 10 80       	push   $0x80107774
80104b89:	57                   	push   %edi
80104b8a:	e8 61 d3 ff ff       	call   80101ef0 <dirlink>
...
80104b9c:	68 73 77 10 80       	push   $0x80107773
80104ba1:	57                   	push   %edi
80104ba2:	e8 49 d3 ff ff       	call   80101ef0 <dirlink>
...
80104bb1:	68 67 77 10 80       	push   $0x80107767
...
80104bcf:	68 76 77 10 80       	push   $0x80107776
80104bd4:	e8 b7 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104bd9:	83 ec 0c             	sub    $0xc,%esp
80104bdc:	68 58 77 10 80       	push   $0x80107758
...
80104c14:	e8 b7 ec ff ff       	call   801038d0 <myproc>
...
80104c59:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104c5b:	e8 70 ec ff ff       	call   801038d0 <myproc>
...
80104d93:	78 2b                	js     80104dc0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104d95:	e8 36 eb ff ff       	call   801038d0 <myproc>
...
80104e52:	0f 88 e2 00 00 00    	js     80104f3a <sys_link+0x11a>
  begin_op();
80104e58:	e8 33 de ff ff       	call   80102c90 <begin_op>
  if((ip = namei(old)) == 0){
80104e5d:	83 ec 0c             	sub    $0xc,%esp
80104e60:	ff 75 d4             	pushl  -0x2c(%ebp)
80104e63:	e8 48 d1 ff ff       	call   80101fb0 <namei>
...
80104e79:	e8 92 c8 ff ff       	call   80101710 <ilock>
  if(ip->type == T_DIR){
...
80104e98:	e8 c3 c7 ff ff       	call   80101660 <iupdate>
  iunlock(ip);
80104e9d:	89 1c 24             	mov    %ebx,(%esp)
80104ea0:	e8 4b c9 ff ff       	call   801017f0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104ea5:	58                   	pop    %eax
80104ea6:	5a                   	pop    %edx
80104ea7:	57                   	push   %edi
80104ea8:	ff 75 d0             	pushl  -0x30(%ebp)
80104eab:	e8 20 d1 ff ff       	call   80101fd0 <nameiparent>
...
80104ebd:	e8 4e c8 ff ff       	call   80101710 <ilock>
...
80104ed3:	e8 18 d0 ff ff       	call   80101ef0 <dirlink>
...
80104ee3:	e8 b8 ca ff ff       	call   801019a0 <iunlockput>
  iput(ip);
80104ee8:	89 1c 24             	mov    %ebx,(%esp)
80104eeb:	e8 50 c9 ff ff       	call   80101840 <iput>
  end_op();
80104ef0:	e8 0b de ff ff       	call   80102d00 <end_op>
  return 0;
...
80104f0c:	e8 8f ca ff ff       	call   801019a0 <iunlockput>
    goto bad;
80104f11:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104f14:	83 ec 0c             	sub    $0xc,%esp
80104f17:	53                   	push   %ebx
80104f18:	e8 f3 c7 ff ff       	call   80101710 <ilock>
  ip->nlink--;
80104f1d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104f22:	89 1c 24             	mov    %ebx,(%esp)
80104f25:	e8 36 c7 ff ff       	call   80101660 <iupdate>
  iunlockput(ip);
80104f2a:	89 1c 24             	mov    %ebx,(%esp)
80104f2d:	e8 6e ca ff ff       	call   801019a0 <iunlockput>
  end_op();
80104f32:	e8 c9 dd ff ff       	call   80102d00 <end_op>
  return -1;
...
80104f45:	e8 56 ca ff ff       	call   801019a0 <iunlockput>
    end_op();
80104f4a:	e8 b1 dd ff ff       	call   80102d00 <end_op>
    return -1;
80104f4f:	83 c4 10             	add    $0x10,%esp
80104f52:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f57:	eb a1                	jmp    80104efa <sys_link+0xda>
    end_op();
80104f59:	e8 a2 dd ff ff       	call   80102d00 <end_op>
    return -1;
...
80104fb4:	e8 57 c7 ff ff       	call   80101710 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104fb9:	58                   	pop    %eax
80104fba:	5a                   	pop    %edx
80104fbb:	68 74 77 10 80       	push   $0x80107774
80104fc0:	53                   	push   %ebx
80104fc1:	e8 5a cc ff ff       	call   80101c20 <namecmp>
...
80104fd4:	68 73 77 10 80       	push   $0x80107773
80104fd9:	53                   	push   %ebx
80104fda:	e8 41 cc ff ff       	call   80101c20 <namecmp>
...
80104ff3:	e8 48 cc ff ff       	call   80101c40 <dirlookup>
...
8010503a:	e8 b1 ca ff ff       	call   80101af0 <writei>
...
801050b4:	e8 37 c9 ff ff       	call   801019f0 <readi>
...
801050cf:	e8 cc c8 ff ff       	call   801019a0 <iunlockput>
    goto bad;
...
801050e4:	e8 b7 c8 ff ff       	call   801019a0 <iunlockput>
  end_op();
...
80105109:	e8 52 c5 ff ff       	call   80101660 <iupdate>
...
80105125:	e9 54 ff ff ff       	jmp    8010507e <sys_unlink+0x10e>
    end_op();
8010512a:	e8 d1 db ff ff       	call   80102d00 <end_op>
    return -1;
...
80105192:	78 79                	js     8010520d <sys_open+0xad>
  ...
  begin_op();
80105194:	e8 f7 da ff ff       	call   80102c90 <begin_op>
...
801051a5:	e8 06 ce ff ff       	call   80101fb0 <namei>
...
801051bb:	e8 50 c5 ff ff       	call   80101710 <ilock>
...
801051d7:	74 23                	je     801051fc <sys_open+0x9c>
  struct proc *curproc = myproc();
801051d9:	e8 f2 e6 ff ff       	call   801038d0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105200:	e8 9b c7 ff ff       	call   801019a0 <iunlockput>
    end_op();
80105205:	e8 f6 da ff ff       	call   80102d00 <end_op>
    return -1;
...
80105233:	75 99                	jne    801051ce <sys_open+0x6e>
      end_op();
80105235:	e8 c6 da ff ff       	call   80102d00 <end_op>
      return -1;
...
80105248:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
8010524b:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
8010524f:	56                   	push   %esi
80105250:	e8 9b c5 ff ff       	call   801017f0 <iunlock>
  end_op();
80105255:	e8 a6 da ff ff       	call   80102d00 <end_op>
...
801052a3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801052a6:	e8 e5 d9 ff ff       	call   80102c90 <begin_op>
...
801052df:	e8 bc c6 ff ff       	call   801019a0 <iunlockput>
  end_op();
801052e4:	e8 17 da ff ff       	call   80102d00 <end_op>
  return 0;
...
80105303:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105306:	e8 85 d9 ff ff       	call   80102c90 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010536e:	e8 2d c6 ff ff       	call   801019a0 <iunlockput>
  end_op();
80105373:	e8 88 d9 ff ff       	call   80102d00 <end_op>
  return 0;
...
8010537f:	90                   	nop
    end_op();
80105380:	e8 7b d9 ff ff       	call   80102d00 <end_op>
    return -1;
...
80105395:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105398:	e8 33 e5 ff ff       	call   801038d0 <myproc>
8010539d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010539f:	e8 ec d8 ff ff       	call   80102c90 <begin_op>
...
801053bf:	e8 ec cb ff ff       	call   80101fb0 <namei>
...
801053d1:	e8 3a c3 ff ff       	call   80101710 <ilock>
  if(ip->type != T_DIR){
...
801053e4:	e8 07 c4 ff ff       	call   801017f0 <iunlock>
  iput(curproc->cwd);
801053e9:	58                   	pop    %eax
801053ea:	ff 76 6c             	pushl  0x6c(%esi)
801053ed:	e8 4e c4 ff ff       	call   80101840 <iput>
  end_op();
801053f2:	e8 09 d9 ff ff       	call   80102d00 <end_op>
  curproc->cwd = ip;
801053f7:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
...
8010542f:	90                   	nop
    end_op();
80105430:	e8 cb d8 ff ff       	call   80102d00 <end_op>
    return -1;
...
80105558:	e8 e3 dd ff ff       	call   80103340 <pipealloc>
...
80105567:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105569:	e8 62 e3 ff ff       	call   801038d0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801055a7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801055aa:	e8 21 e3 ff ff       	call   801038d0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801055af:	31 d2                	xor    %edx,%edx
801055b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
801055b8:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
801055c6:	75 f0                	jne    801055b8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801055c8:	e8 03 e3 ff ff       	call   801038d0 <myproc>
...
{
  return fork();
80105600:	e9 8b e4 ff ff       	jmp    80103a90 <fork>
...
80105613:	83 ec 08             	sub    $0x8,%esp
  exit();
80105616:	e8 05 e7 ff ff       	call   80103d20 <exit>
...
{
  return wait();
80105620:	e9 9b e9 ff ff       	jmp    80103fc0 <wait>
...
8010564e:	e8 cd ea ff ff       	call   80104120 <kill>
...
80105673:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105676:	e8 55 e2 ff ff       	call   801038d0 <myproc>
8010567b:	8b 40 14             	mov    0x14(%eax),%eax
}
8010567e:	c9                   	leave  
8010567f:	c3                   	ret    
...
80105697:	78 27                	js     801056c0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105699:	e8 32 e2 ff ff       	call   801038d0 <myproc>
  if(growproc(n) < 0)
...
801056a6:	e8 65 e3 ff ff       	call   80103a10 <growproc>
...
801056f5:	e8 16 ee ff ff       	call   80104510 <acquire>
  ticks0 = ticks;
...
8010571d:	e8 de e7 ff ff       	call   80103f00 <sleep>
  while(ticks - ticks0 < n){
...
8010572f:	73 2f                	jae    80105760 <sys_sleep+0x90>
    if(myproc()->killed){
80105731:	e8 9a e1 ff ff       	call   801038d0 <myproc>
80105736:	8b 40 28             	mov    0x28(%eax),%eax
...
8010578c:	e8 7f ed ff ff       	call   80104510 <acquire>
  xticks = ticks;
...
8010580f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105812:	a1 08 a1 10 80       	mov    0x8010a108,%eax
...
80105834:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010583a:	e8 71 eb ff ff       	call   801043b0 <initlock>
}
...
80105892:	0f 84 b8 01 00 00    	je     80105a50 <trap+0x1d0>
    if(myproc()->killed)
      exit();
    return;
  }
...
801058b0:	e8 1b e0 ff ff       	call   801038d0 <myproc>
801058b5:	8b 5f 38             	mov    0x38(%edi),%ebx
801058b8:	85 c0                	test   %eax,%eax
801058ba:	0f 84 17 02 00 00    	je     80105ad7 <trap+0x257>
801058c0:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
801058c4:	0f 84 0d 02 00 00    	je     80105ad7 <trap+0x257>
...
801058d0:	e8 db df ff ff       	call   801038b0 <cpuid>
801058d5:	8b 77 30             	mov    0x30(%edi),%esi
801058d8:	89 45 dc             	mov    %eax,-0x24(%ebp)
801058db:	8b 47 34             	mov    0x34(%edi),%eax
801058de:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801058e1:	e8 ea df ff ff       	call   801038d0 <myproc>
801058e6:	89 45 e0             	mov    %eax,-0x20(%ebp)
801058e9:	e8 e2 df ff ff       	call   801038d0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801058fa:	ff 75 e4             	pushl  -0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
801058fd:	83 c2 70             	add    $0x70,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105900:	56                   	push   %esi
80105901:	52                   	push   %edx
80105902:	ff 70 14             	pushl  0x14(%eax)
80105905:	68 1c 78 10 80       	push   $0x8010781c
8010590a:	e8 a1 ad ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
8010590f:	83 c4 20             	add    $0x20,%esp
80105912:	e8 b9 df ff ff       	call   801038d0 <myproc>
80105917:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
8010591e:	e8 ad df ff ff       	call   801038d0 <myproc>
80105923:	85 c0                	test   %eax,%eax
80105925:	74 1d                	je     80105944 <trap+0xc4>
80105927:	e8 a4 df ff ff       	call   801038d0 <myproc>
8010592c:	8b 50 28             	mov    0x28(%eax),%edx
...
8010593e:	0f 84 44 01 00 00    	je     80105a88 <trap+0x208>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105944:	e8 87 df ff ff       	call   801038d0 <myproc>
80105949:	85 c0                	test   %eax,%eax
8010594b:	74 0b                	je     80105958 <trap+0xd8>
8010594d:	e8 7e df ff ff       	call   801038d0 <myproc>
80105952:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
80105956:	74 38                	je     80105990 <trap+0x110>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105958:	e8 73 df ff ff       	call   801038d0 <myproc>
8010595d:	85 c0                	test   %eax,%eax
8010595f:	74 1d                	je     8010597e <trap+0xfe>
80105961:	e8 6a df ff ff       	call   801038d0 <myproc>
80105966:	8b 40 28             	mov    0x28(%eax),%eax
80105969:	85 c0                	test   %eax,%eax
8010596b:	74 11                	je     8010597e <trap+0xfe>
8010596d:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105971:	83 e0 03             	and    $0x3,%eax
80105974:	66 83 f8 03          	cmp    $0x3,%ax
80105978:	0f 84 fb 00 00 00    	je     80105a79 <trap+0x1f9>
    exit();
}
...
80105994:	75 c2                	jne    80105958 <trap+0xd8>
    yield();
80105996:	e8 d5 e4 ff ff       	call   80103e70 <yield>
8010599b:	eb bb                	jmp    80105958 <trap+0xd8>
8010599d:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801059a0:	e8 0b df ff ff       	call   801038b0 <cpuid>
801059a5:	85 c0                	test   %eax,%eax
801059a7:	0f 84 eb 00 00 00    	je     80105a98 <trap+0x218>
    lapiceoi();
801059ad:	e8 8e ce ff ff       	call   80102840 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059b2:	e8 19 df ff ff       	call   801038d0 <myproc>
801059b7:	85 c0                	test   %eax,%eax
801059b9:	0f 85 68 ff ff ff    	jne    80105927 <trap+0xa7>
801059bf:	eb 83                	jmp    80105944 <trap+0xc4>
801059c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801059c8:	e8 33 cd ff ff       	call   80102700 <kbdintr>
    lapiceoi();
801059cd:	e8 6e ce ff ff       	call   80102840 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059d2:	e8 f9 de ff ff       	call   801038d0 <myproc>
801059d7:	85 c0                	test   %eax,%eax
801059d9:	0f 85 48 ff ff ff    	jne    80105927 <trap+0xa7>
801059df:	e9 60 ff ff ff       	jmp    80105944 <trap+0xc4>
801059e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
801059e8:	e8 83 02 00 00       	call   80105c70 <uartintr>
    lapiceoi();
801059ed:	e8 4e ce ff ff       	call   80102840 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059f2:	e8 d9 de ff ff       	call   801038d0 <myproc>
801059f7:	85 c0                	test   %eax,%eax
801059f9:	0f 85 28 ff ff ff    	jne    80105927 <trap+0xa7>
801059ff:	e9 40 ff ff ff       	jmp    80105944 <trap+0xc4>
80105a04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105a08:	8b 77 38             	mov    0x38(%edi),%esi
80105a0b:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105a0f:	e8 9c de ff ff       	call   801038b0 <cpuid>
80105a14:	56                   	push   %esi
80105a15:	53                   	push   %ebx
80105a16:	50                   	push   %eax
80105a17:	68 c4 77 10 80       	push   $0x801077c4
80105a1c:	e8 8f ac ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105a21:	e8 1a ce ff ff       	call   80102840 <lapiceoi>
    break;
80105a26:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a29:	e8 a2 de ff ff       	call   801038d0 <myproc>
80105a2e:	85 c0                	test   %eax,%eax
80105a30:	0f 85 f1 fe ff ff    	jne    80105927 <trap+0xa7>
80105a36:	e9 09 ff ff ff       	jmp    80105944 <trap+0xc4>
80105a3b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105a3f:	90                   	nop
    ideintr();
80105a40:	e8 0b c7 ff ff       	call   80102150 <ideintr>
80105a45:	e9 63 ff ff ff       	jmp    801059ad <trap+0x12d>
80105a4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105a50:	e8 7b de ff ff       	call   801038d0 <myproc>
80105a55:	8b 58 28             	mov    0x28(%eax),%ebx
80105a58:	85 db                	test   %ebx,%ebx
80105a5a:	75 74                	jne    80105ad0 <trap+0x250>
    myproc()->tf = tf;
80105a5c:	e8 6f de ff ff       	call   801038d0 <myproc>
80105a61:	89 78 1c             	mov    %edi,0x1c(%eax)
    syscall();
80105a64:	e8 87 ef ff ff       	call   801049f0 <syscall>
    if(myproc()->killed)
80105a69:	e8 62 de ff ff       	call   801038d0 <myproc>
80105a6e:	8b 48 28             	mov    0x28(%eax),%ecx
80105a71:	85 c9                	test   %ecx,%ecx
80105a73:	0f 84 05 ff ff ff    	je     8010597e <trap+0xfe>
}
...
80105a7f:	5d                   	pop    %ebp
      exit();
80105a80:	e9 9b e2 ff ff       	jmp    80103d20 <exit>
80105a85:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105a88:	e8 93 e2 ff ff       	call   80103d20 <exit>
80105a8d:	e9 b2 fe ff ff       	jmp    80105944 <trap+0xc4>
80105a92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105a98:	83 ec 0c             	sub    $0xc,%esp
80105a9b:	68 60 4d 11 80       	push   $0x80114d60
80105aa0:	e8 6b ea ff ff       	call   80104510 <acquire>
      wakeup(&ticks);
80105aa5:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105aac:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105ab3:	e8 f8 e5 ff ff       	call   801040b0 <wakeup>
      release(&tickslock);
80105ab8:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105abf:	e8 0c eb ff ff       	call   801045d0 <release>
80105ac4:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105ac7:	e9 e1 fe ff ff       	jmp    801059ad <trap+0x12d>
80105acc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      exit();
80105ad0:	e8 4b e2 ff ff       	call   80103d20 <exit>
80105ad5:	eb 85                	jmp    80105a5c <trap+0x1dc>
80105ad7:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105ada:	e8 d1 dd ff ff       	call   801038b0 <cpuid>
...
80105aed:	e8 be ab ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105af2:	83 c4 14             	add    $0x14,%esp
80105af5:	68 be 77 10 80       	push   $0x801077be
80105afa:	e8 91 a8 ff ff       	call   80100390 <panic>
80105aff:	90                   	nop
...
80105bef:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105bf4:	bb e0 78 10 80       	mov    $0x801078e0,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010675a:	e8 c1 de ff ff       	call   80104620 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801068a9:	68 86 72 10 80       	push   $0x80107286
...
801068c3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801068c6:	e8 e5 cf ff ff       	call   801038b0 <cpuid>
  pd[0] = size-1;
...
8010696e:	0f 84 cb 00 00 00    	je     80106a3f <switchuvm+0xdf>
  if(p->kstack == 0)
80106974:	8b 43 0c             	mov    0xc(%ebx),%eax
80106977:	85 c0                	test   %eax,%eax
80106979:	0f 84 da 00 00 00    	je     80106a59 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010697f:	8b 43 08             	mov    0x8(%ebx),%eax
80106982:	85 c0                	test   %eax,%eax
80106984:	0f 84 c2 00 00 00    	je     80106a4c <switchuvm+0xec>
  pushcli();
8010698a:	e8 91 da ff ff       	call   80104420 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010698f:	e8 9c ce ff ff       	call   80103830 <mycpu>
80106994:	89 c6                	mov    %eax,%esi
80106996:	e8 95 ce ff ff       	call   80103830 <mycpu>
8010699b:	89 c7                	mov    %eax,%edi
8010699d:	e8 8e ce ff ff       	call   80103830 <mycpu>
801069a2:	83 c7 08             	add    $0x8,%edi
801069a5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801069a8:	e8 83 ce ff ff       	call   80103830 <mycpu>
...
80106a39:	5d                   	pop    %ebp
  popcli();
80106a3a:	e9 31 da ff ff       	jmp    80104470 <popcli>
...
80106a9f:	e8 7c db ff ff       	call   80104620 <memset>
...
80106ad0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ad1:	e9 ea db ff ff       	jmp    801046c0 <memmove>
...
80106bfb:	e8 20 da ff ff       	call   80104620 <memset>
...
80106c93:	68 7d 79 10 80       	push   $0x8010797d
...
80106db0:	e8 6b d8 ff ff       	call   80104620 <memset>
...
80106ea0:	e8 1b d8 ff ff       	call   801046c0 <memmove>
...
80106f39:	68 ce 79 10 80       	push   $0x801079ce

...
main(int argc,char *argv[])
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
	...
	if(forkt(8)==0)
  11:	6a 08                	push   $0x8
  13:	e8 39 03 00 00       	call   351 <forkt>
  18:	83 c4 10             	add    $0x10,%esp
  1b:	85 c0                	test   %eax,%eax
  1d:	75 13                	jne    32 <main+0x32>
	{
		printf(1,"8\n");
  1f:	52                   	push   %edx
  20:	52                   	push   %edx
  ...
  28:	e8 03 04 00 00       	call   430 <printf>
		exit();
  2d:	e8 7f 02 00 00       	call   2b1 <exit>
	}
	if(fork()==0)
  32:	e8 72 02 00 00       	call   2a9 <fork>
  37:	85 c0                	test   %eax,%eax
  39:	75 13                	jne    4e <main+0x4e>
	{
		printf(1,"a\n");
  3b:	50                   	push   %eax
  3c:	50                   	push   %eax
  3d:	68 9b 07 00 00       	push   $0x79b
  42:	6a 01                	push   $0x1
  44:	e8 e7 03 00 00       	call   430 <printf>
		exit();
  49:	e8 63 02 00 00       	call   2b1 <exit>
	}
	wait();
  4e:	e8 66 02 00 00       	call   2b9 <wait>
	wait();
  53:	e8 61 02 00 00       	call   2b9 <wait>
	exit();
  58:	e8 54 02 00 00       	call   2b1 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb 9e 07 00 00       	mov    $0x79e,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 50 0a 00 00    	mov    0xa50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	8b 15 50 0a 00 00    	mov    0xa50,%edx

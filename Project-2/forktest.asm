  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  49:	68 8c 04 00 00       	push   $0x48c
  4e:	e8 ad 01 00 00       	call   200 <strlen>
  53:	83 c4 0c             	add    $0xc,%esp
  56:	50                   	push   %eax
  57:	68 8c 04 00 00       	push   $0x48c
  5c:	6a 01                	push   $0x1
  ...
  6d:	8d 76 00             	lea    0x0(%esi),%esi
    if(pid == 0)
  70:	74 78                	je     ea <forktest+0xaa>
  for(n=0; n<N; n++){
  72:	83 c3 01             	add    $0x1,%ebx
  75:	83 fb 3c             	cmp    $0x3c,%ebx
  78:	0f 84 b5 00 00 00    	je     133 <forktest+0xf3>
    pid = fork();
  ...
  int b = gettsched();
  87:	e8 e5 03 00 00       	call   471 <gettsched>
  write(fd, s, strlen(s));
  8c:	83 ec 0c             	sub    $0xc,%esp
  8f:	68 cc 04 00 00       	push   $0x4cc
  94:	e8 67 01 00 00       	call   200 <strlen>
  99:	83 c4 0c             	add    $0xc,%esp
  9c:	50                   	push   %eax
  9d:	68 cc 04 00 00       	push   $0x4cc
  a2:	6a 01                	push   $0x1
  a4:	e8 48 03 00 00       	call   3f1 <write>
  for(; n > 0; n--){
  a9:	83 c4 10             	add    $0x10,%esp
  ac:	85 db                	test   %ebx,%ebx
  ae:	74 0e                	je     be <forktest+0x7e>
    if(wait() < 0){
  b0:	e8 24 03 00 00       	call   3d9 <wait>
  b5:	85 c0                	test   %eax,%eax
  b7:	78 36                	js     ef <forktest+0xaf>
  for(; n > 0; n--){
  b9:	83 eb 01             	sub    $0x1,%ebx
  bc:	75 f2                	jne    b0 <forktest+0x70>
  if(wait() != -1){
  be:	e8 16 03 00 00       	call   3d9 <wait>
  c3:	83 f8 ff             	cmp    $0xffffffff,%eax
  c6:	75 49                	jne    111 <forktest+0xd1>
  write(fd, s, strlen(s));
  c8:	83 ec 0c             	sub    $0xc,%esp
  cb:	68 be 04 00 00       	push   $0x4be
  d0:	e8 2b 01 00 00       	call   200 <strlen>
  d5:	83 c4 0c             	add    $0xc,%esp
  d8:	50                   	push   %eax
  d9:	68 be 04 00 00       	push   $0x4be
  de:	6a 01                	push   $0x1
  e0:	e8 0c 03 00 00       	call   3f1 <write>
}
  e5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  e8:	c9                   	leave  
  e9:	c3                   	ret    
      exit();
  ea:	e8 e2 02 00 00       	call   3d1 <exit>
  write(fd, s, strlen(s));
  ef:	83 ec 0c             	sub    $0xc,%esp
  f2:	68 97 04 00 00       	push   $0x497
  f7:	e8 04 01 00 00       	call   200 <strlen>
  fc:	83 c4 0c             	add    $0xc,%esp
  ff:	50                   	push   %eax
 100:	68 97 04 00 00       	push   $0x497
 105:	6a 01                	push   $0x1
 107:	e8 e5 02 00 00       	call   3f1 <write>
      exit();
 10c:	e8 c0 02 00 00       	call   3d1 <exit>
  write(fd, s, strlen(s));
 111:	83 ec 0c             	sub    $0xc,%esp
 114:	68 ab 04 00 00       	push   $0x4ab
 119:	e8 e2 00 00 00       	call   200 <strlen>
 11e:	83 c4 0c             	add    $0xc,%esp
 121:	50                   	push   %eax
 122:	68 ab 04 00 00       	push   $0x4ab
 127:	6a 01                	push   $0x1
 129:	e8 c3 02 00 00       	call   3f1 <write>
    exit();
 12e:	e8 9e 02 00 00       	call   3d1 <exit>
  int b = gettsched();
 133:	e8 39 03 00 00       	call   471 <gettsched>
  write(fd, s, strlen(s));
 138:	83 ec 0c             	sub    $0xc,%esp
 13b:	68 cc 04 00 00       	push   $0x4cc
 140:	e8 bb 00 00 00       	call   200 <strlen>
 145:	83 c4 0c             	add    $0xc,%esp
 148:	50                   	push   %eax
 149:	68 cc 04 00 00       	push   $0x4cc
 14e:	6a 01                	push   $0x1
 150:	e8 9c 02 00 00       	call   3f1 <write>
 155:	c7 04 24 dc 04 00 00 	movl   $0x4dc,(%esp)
 15c:	e8 9f 00 00 00       	call   200 <strlen>
 161:	83 c4 0c             	add    $0xc,%esp
 164:	50                   	push   %eax
 165:	68 dc 04 00 00       	push   $0x4dc
 16a:	6a 01                	push   $0x1
 16c:	e8 80 02 00 00       	call   3f1 <write>
    exit();
 171:	e8 5b 02 00 00       	call   3d1 <exit>
...
00000479 <getcycles1>:
SYSCALL(getcycles1)
 479:	b8 18 00 00 00       	mov    $0x18,%eax
 47e:	cd 40                	int    $0x40
 480:	c3                   	ret    
